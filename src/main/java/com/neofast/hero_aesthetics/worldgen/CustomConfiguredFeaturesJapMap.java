...
/* 23 */     register(context, JAP_MAP_KEY, Feature.f_65760_, (new TreeConfiguration.TreeConfigurationBuilder(
/* 24 */           (BlockStateProvider)BlockStateProvider.m_191382_((Block)ModBlocks.JAP_MAP_LOG.get()), (TrunkPlacer)new StraightTrunkPlacer(5, 4, 3), 
/*    */ 
/*    */           
/* 27 */           (BlockStateProvider)BlockStateProvider.m_191382_((Block)ModBlocks.JAP_MAP_LEAVES.get()), (FoliagePlacer)new BlobFoliagePlacer(
